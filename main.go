...
func createEvent(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		fmt.Fprintf(w, "Kindly enter data with the event: title, description, only in order to update")
	}
...
func updateEvent(w http.ResponseWriter, r *http.Request) {
	...
	reqBody, err := ioutil.ReadAll(r.Body)
	if err != nil {
		fmt.Fprintf(w, "Kindle enter data with the event")
	}
